...
{{< petition-cta
  ...
  subtext="Sign on to ask the City of Redwood City for parity of investment — bulb-outs, roundabouts, and speed bumps on Spring." >}}

## What we're asking for

- **Parity of investment.** When Bay Road gets calming infrastructure, Spring Street should get equivalent treatment to absorb the spillover.
- **Grant allocation** for traffic-calming measures on Spring: bulb-outs, mini-roundabouts, raised crosswalks, and speed humps.
- **Interim mitigation** during Bay Road construction, when spillover will be at its worst.

## Why now

Construction on Bay Road is coming. Once it starts, Spring Street will see an immediate jump in cut-through traffic. The window to advocate for upstream design changes — before our street becomes the de-facto bypass — is closing.

[Read the full Bay Road project explainer →]({{< ref "bay-road-project" >}})
